...
webpackJsonp = (...args) => {
    ...
    const parserIdx = modules.findIndex(i => i && i.toString && i.toString().match(/gifSearch:"SHOW_GIF_SEARCH"/));
    if (!parserIdx) {
        return orig(...args);
    }
    ...
    function newParser(e, t, a) {
        parser(e, t, a);
        const oldHandle = e.exports.handle;
        const newHandle = function(param) {
